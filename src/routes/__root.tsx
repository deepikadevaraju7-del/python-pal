...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ask Python questions in plain English and get instant answers from a curated reference deck." },
      { name: "author", content: "PyCard" },
      { property: "og:title", content: "PyCard — Python Q&A Chatbot" },
      { property: "og:description", content: "Ask Python questions in plain English and get instant answers from a curated reference deck." },
